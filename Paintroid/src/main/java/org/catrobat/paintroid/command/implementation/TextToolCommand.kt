...
class TextToolCommand(multilineText: Array<String>, textPaint: Paint, boxOffset: Float,
                      boxWidth: Float, boxHeight: Float, toolPosition: PointF,
                      rotationAngle: Float, typeFaceInfo: SerializableTypeface) : Command {
    ...
    override fun run(canvas: Canvas, layerModel: LayerContracts.Model) {
        ...
        val textBitmap = Bitmap.createBitmap(textBoxWidth.toInt(), textBoxHeight.toInt(),
        ...
        val dstRect = Rect((-boxWidth / 2.0f).toInt(), (-boxHeight / 2.0f).toInt(),
